<template>
	<div class="right-board">
		<el-tabs v-model="currentTab" class="right-board-tabs">
		...
		<div class="field-box">
			<el-scrollbar class="right-scrollbar">
				...
				<el-form v-show="currentTab === 'field' && showField" size="small" label-width="90px">
					...
					<!-- 明细表格 -->
					<template v-if="activeData.__config__.layout == 'tableList'">
						<el-form-item v-if="activeData.titleText !== undefined" label="标题">
							<el-input
								v-model="activeData.titleText"
								placeholder="请输入标题"
								@input="changeRenderKey"
								clearable
								maxlength="20"
						...
						<el-form-item v-if="activeData.buttonText !== undefined" label="按钮">
							<el-input
...
::v-deep .right-board-tabs.el-tabs--top .el-tabs__item.is-top:nth-child(2) {
	padding-left: 20px;
}
.select-item {
	display: flex;
