          ...
          <el-col :span="12">
            <el-form-item label="负责人" prop="leaderId">
              <!-- <el-input v-model="form.leaderId" placeholder="请输入负责人" maxlength="20" /> -->
                <el-select filterable v-model="form.leaderId" placeholder="请选择" clearable>
                    <el-option
  ...
  methods: {
    ...
    submitForm: function() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          let temp = this.allUsers.find(e => {return e.userId == this.form.leaderId})
          this.form.leader = temp ? temp.nickName : ''
